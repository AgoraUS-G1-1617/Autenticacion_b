...
if (!isset($_SESSION["registerTwitter"])) {
    $registerTwitter["nombre"] = $_POST["nombre"];
    $registerTwitter["email"] = $_POST["email"];
    $registerTwitter["apellido"] = $_POST["apellido"];
    $registerTwitter["genero"] = $_POST["genero"];
} else {
    $registerTwitter = $_SESSION['registerTwitter'];
}

$_SESSION['registerForm'] = $registerForm;

$_SESSION["registerTwitter"]=$registerTwitter;
...
<div align="left">
    <form id="registerForm" onsubmit="return form_process()" method="POST" action="action_register.php" class="styleForm">
        ...
        <input  type="email" id="email" name="email" class="inputForm" disabled value=<?php echo htmlentities($registerTwitter['email']) ?>>
        <br />
        <br />
        ...
        <input  type="text" id="name" name="name" class="inputForm" value=<?php echo htmlentities($registerTwitter['nombre']) ?>>
        <br>

        <label for="surname" class="labelForm">Apellidos:</label>
        <input  type="text" id="surname" name="surname" class="inputForm" value=<?php echo htmlentities($registerTwitter['apellido']) ?>>
        <br>
